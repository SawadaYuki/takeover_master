...
c --sawada org:s 
      call mpi_allreduce(t0,t,1,dp_type,mpi_max,mpi_comm_world,ierr)
c --sawada org:e 
      verified = .FALSE.
      verify_value = 0.0
      if( me .eq. root )then
