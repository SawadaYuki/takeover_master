...
static int _nextConId = CONNECTION_ID_START;//CONNECTION_ID_START=99000
static int _nextConnectionId()
{
  //static int id = CONNECTION_ID_START;
  //JTRACE("called _nextConnectionId()")(_nextConId)(_nextConId++);
  return _nextConId++;
}
...
{
  JTRACE("return _nextConnectionId()")(_nextConId)(_nextConnectionId());
  //printf("print:conId=%d\n",_nextConnectionId());
