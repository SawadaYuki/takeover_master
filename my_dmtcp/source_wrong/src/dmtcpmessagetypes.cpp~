...
#define OSHIFTPRINTF(name) case name: o << #name; break;
      ...
      OSHIFTPRINTF ( DMT_RESTART_WORKER_WITH_CHG_DOMAIN ) //sawada add 
...
//sawada org:s 
void dmtcp::DmtcpMessage::changeMsgType( DmtcpMessageType t)
{
  DmtcpMessageType tempMsgType = type;
  type = t;
  JTRACE("change MSg Type")(tempMsgType)(type);
}
//sawada org:e 

//dmtcp::procIpSet::procIpSet()

//dmtcp::procIpSet::setPidAndIP(int index,pid_t pid,char ip[8])
