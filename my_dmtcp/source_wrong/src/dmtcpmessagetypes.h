...
#define DMTCPMESSAGE_SAME_CKPT_INTERVAL (~0u) /* default value */
  ...
  /*     index = 0; */
  /*     int k; */
  /*     memset(pidSet, 0, sizeof(pidSet)); */
  /*     memset(isParent, 0, sizeof(isParent)); */
  /*     for(k= 0;k<size;k++){ */
  /* 	//pidSet[k] = 0; */
  /* 	strncpy(ipSet[k],"0",15);  */
  /*     } */
  /*   } */
  /*   int getIndex(){return index;} */
  /*   void setPidAndIp(int x,pid_t pid,dmtcp::string ip) */
  /*   { */
  /*     pidSet[x] = pid;  */
  /*     strncpy(ipSet[x],ip.c_str(),sizeof ipSet[x]); */
  /*     index++; */
  /*   } */
  /*   void setParentFlg(int x) */
  /*   { */
  /*     isParent[x] = 1; */
  /*   } */
  /*   int pidSet[20]; */
