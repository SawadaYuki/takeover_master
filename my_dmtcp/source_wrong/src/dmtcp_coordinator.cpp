...
map<dmtcp::UniquePid,int> sentHostidForParent; //各親プロセスに送信したホストID.記録したホストIDをきちんと全部遅れたかを確認する用
                                               ...
                                               int numPeers)
{
  ...
  // sawada original :start
  dmtcp::string processLocation = ""; //(PID1+PID2+ ... /IP1+IP2+... /IsParent + IsParent +...
  // sawada original :end
